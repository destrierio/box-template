...
# Blocks common command-execution gadgets but still evaluates template expressions.
...
<html>
  ...
  <body>
    ...
    <ul>
      <li><code>POST /preview</code>: render a draft with the <code>template</code> form parameter</li>
    </ul>
...
def preview():
    ...
    try:
        # VULNERABLE: user-controlled input is rendered as a server-side template.
