...
The endpoint joins a user-supplied filename with the document directory without normalizing the path or checking that the resolved file stays inside the allowed location.
